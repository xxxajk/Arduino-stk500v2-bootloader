 ...
 * Jul  3, 2010 <MLS> More #ifdefs to conserve space and testing on most of
 *                     my boards
 * Jul  4, 2010 <MLS> Started using vector defs for #ifdefs as defined in
 *                     <avr/io.h>
 * Jul 13, 2010 <MLS> Added support for __AVR_ATmega128__
 * Aug 26, 2010 <MLS> Added support for __AVR_ATmega2561__
 * Sep 13, 2010 <MLS> Added support for __AVR_AT90CAN32__
 *                     __AVR_AT90CAN64__ __AVR_AT90CAN128__
 ****************************************************************************
 * This defines the interrupt vectors and allows us to compile ONLY those
 * strings that are actually in the target CPU. This way we do not have to
 * keep making changes based on CPU, it will be automatic even if we add a
 * new CPU.
 ****************************************************************************/
#ifndef _AVR_IO_H_
#include <avr/io.h>
